...
class PathViewer(Node):
    def __init__(self, frame_id, period):
        ...
        #self.file_path = self.declare_parameter("file_path", "/home/gjs/global_path/stair.txt").value
        # self.file_path = self.declare_parameter("file_path", "/home/gjs/global_path/stair_.txt").value
